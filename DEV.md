...
`compose_edited_update` вызывает редактор с timeout 100 s, 11000 output tokens,
low reasoning и JSON output. Проверяются completed status, структура, дословное
